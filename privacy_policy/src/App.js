  ...
  return (
    ...
    <Para para="We gather two types of information about users through the Site:"
     ...
     <ul className="para_list">
       ...
       <li>Account Registration. If you register for an account on our Site, you may be required to provide us with Personal Data such as your name and email address.</li>
       <li>Updates. DevsCart may offer you the ability to receive updates either via email or by posting on portions of the Site only accessible to registered users. In order to subscribe to these Services, you may be required to provide us with Personal Data such as your name and email address.</li>
       <li>Forums. DevsCart may offer public forums from time to time (the "Forums") where you can share comments and thoughts. In order to participate in the Forums, you may be required to register with us and/or provide us with Personal Data such as your name and email address. </li>
       <li>Participation in Content Offerings. DevsCart offers users the opportunity to participate in Content Offerings on or through the Site. If you desire to participate in a Content Offering, you will be asked to provide us with certain information necessary to conduct such a Content Offering.</li>
     </ul>
    </div>
    </div>
  );
